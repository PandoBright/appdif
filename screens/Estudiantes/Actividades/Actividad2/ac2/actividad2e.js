...
const Emociones = () => {
    ...
    const resetGame = () => {
        const correctImagesFolder = require.context('../../../../../assets/Actividades/Emociones/Sorprendidos', false, /\.(jpg|jpeg|png)$/);
        ...
        const incorrectImagesFolders = [
            require.context('../../../../../assets/Actividades/Emociones/Felicidad', false, /\.(jpg|jpeg|png)$/),
            require.context('../../../../../assets/Actividades/Emociones/Tristeza', false, /\.(jpg|jpeg|png)$/),
        ];
    ...
    return (
        <View style={styles.container}>
            ...
            <Text style={styles.title}>¿Quién está Sorpresivo?</Text>
